    ...
    <div className={styles.container} >
      ...
      <div className={styles.card}>
        <div >
          <h3>Missão</h3>
          <span id={styles.text}>
            levar a psicologia a todos, acreditando que a vida é uma escola e aprender a viver conectado a nossas essência é a lição mais importante para viver cada dia MELHOR!
          </span>
        </div>
        <div>
          <h3>Missão</h3>
        ...
        <div>
          <h3>Valores</h3>
          <span id={styles.text}>
            Sou uma alma humana, comprometida, determinada, de coração grato e motivada. Apaixonada pelo que faz, tenho como essência trabalhar ajudando as pessoas na busca do seu PROPÓSITO, QUALIDADE DE VIDA, SAÚDE MENTAL e sua MELHOR VERSÃO!
          </span>
        </div>
      </div>
    </div>
