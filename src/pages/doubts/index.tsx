    ...
    const questions: Question[] = [
      {
        ...
        answer:
          'Existem momentos na vida que passamos por situações difíceis,' +
      ...
      },
      {
        ...
        answer:
          'O psicólogo  atuará com habilidades para tratar, por meio de técnicas da psicoterapia,' +
      ...
      },
      {
        ...
        answer:
          'A psicoterapia é um processo terapêutico em que junto com o paciente o profissional irá auxiliar em suas demandas emocionais e/ou psíquicas. Com objetivo de restabelecer a saúde e qualidade de vida do paciente.',
      },
      {
        title: 'Como faço para agendar uma consulta?',
        answer:
          'Parabéns por ter chegado a essa etapa!!\n\n' +
      ...
      <div className={styles.content} key={index}>
        <div className={styles.question} onClick={() => toggleAnswer(index)}>
          ...
          <FontAwesomeIcon
            ...
            icon={faAngleDown}
            rotation={
              activeIndex === index ? (180 as RotateProp) : (0 as RotateProp)
            }
          />
        </div>
        <div
